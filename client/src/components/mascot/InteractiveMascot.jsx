    ...
    >
      <defs>
        ...
        <pattern id="sleepingCapPattern" width="40" height="40" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          <rect width="20" height="40" fill="#6366F1" />
        ...
        >
          ...
          {accessories?.party_hat && (
            <g className="mascot-accessory-partyhat" style={{ transition: 'all 0.5s ease' }} transform="translate(186, -84) scale(0.29)">
              <g>
                <path fill="#6366F1" d="M217.545,147.142l-46.827,90.59c42.288-17.282,87.413-44.99,124.354-89.397l-10.556-20.428 c-8.538,4.422-18.239,6.921-28.517,6.921c-10.278,0-19.972-2.5-28.51-6.921L217.545,147.142z"/>
                <path fill="#2DD4BF" d="M295.071,148.335c-36.942,44.407-82.067,72.115-124.354,89.397l-61.614,119.184 c59.116-9.132,159.956-38.21,226.257-130.643L295.071,148.335z"/>
                <path fill="#6366F1" d="M335.361,226.272c-66.301,92.431-167.143,121.51-226.257,130.643l-31.466,60.871 c0,0,184.403,3.021,281.499-145.516L335.361,226.272z"/>
                <path fill="#2DD4BF" d="M359.137,272.27C262.04,420.807,77.637,417.786,77.637,417.786L57.758,456.24 c27.816,16.055,61.726,27.847,98.484,35.331c35.248-3.83,166.632-25.27,245.735-136.424L359.137,272.27z"/>
                <path fill="#6366F1" d="M401.979,355.148c-79.104,111.154-210.488,132.594-245.735,136.423 c54.549,11.124,115.364,12.759,171.805,4.796c35.55-21.159,70.918-50.947,98.926-92.866L401.979,355.148z"/>
                <path fill="#2DD4BF" d="M426.974,403.503c-28.008,41.919-63.376,71.706-98.926,92.866 c47.19-6.642,91.327-19.997,126.192-40.127L426.974,403.503z"/>
          ...
          {accessories?.sleeping_cap && (
            <g transform="translate(192, -58) scale(0.26)">
              <g className="mascot-accessory-sleepingcap" style={{ transition: 'all 0.5s ease' }}>
                ...
                {/* Cap Body Fill */}
                <path fill="#6366F1" d="M107.181,242.034c23.315-34.352,55.09-61.954,89.86-83.645 c31.47-19.659,66.222-28.332,99.885-35.916c16.818-3.81,33.332-7.355,48.994-12.117c10.016-3.053,19.659-6.726,28.817-11.275 c3.069,24.692,19.14,45.321,41.197,54.776c-7.321,8.265-13.077,16.675-17.142,25.263c-5.97,12.533-8.477,25.347-8.461,37.744 c0.009,14.388,3.24,28.171,7.72,41.487c6.76,19.956,16.368,39.13,24.005,58.169c5.492,13.613,9.897,27.039,11.98,40.406H68.008 C71.154,311.724,85.54,273.954,107.181,242.034z"/>
                {/* Decorative Spots */}
                <circle cx="180" cy="220" r="12" fill="#2DD4BF" />
                <circle cx="250" cy="180" r="14" fill="#2DD4BF" />
                <circle cx="310" cy="150" r="10" fill="#2DD4BF" />
                {/* Pom-pom Fill */}
      ...
      {action === 'writing' && (
        <g className="mascot-prop-notepad" style={{ transform: 'translate(200px, 320px)', transition: 'all 0.5s ease' }}>
          ...
          <line x1="10" y1="10" x2="50" y2="10" stroke="#6366F1" strokeWidth="2.5" />
