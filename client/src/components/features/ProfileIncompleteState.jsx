  ...
  return (
    <div className="min-h-screen bg-[#0f0f1a] text-white font-sans">
      <div className="max-w-xl mx-auto px-6 py-24 text-center space-y-6">
        ...
        <ul className="text-left text-sm text-slate-300 bg-[#16162a] border border-white/10 rounded-2xl p-5 space-y-2">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link
            to="/profile"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#6366F1] hover:bg-[#5558DD] text-[#0f0f1a] text-sm font-bold transition-colors"
          >
